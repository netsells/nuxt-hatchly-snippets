...
export default function SnippetsModule(moduleOptions = {}) {
    ...
    this.addTemplate({
        src: resolve(__dirname, './snippets.json'),
        fileName: './hatchly-snippets/snippets.json',
    });
    ...
    this.options.router.middleware.unshift('snippets');

    this.options.serverMiddleware.unshift(serverMiddleware({
        ...options,
        ...nuxt.options.privateRuntimeConfig.hatchly.snippets,
        ...nuxt.options.publicRuntimeConfig.hatchly.snippets,
